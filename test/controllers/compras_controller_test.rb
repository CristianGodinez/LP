...
class ComprasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create compra" do
    assert_difference("Compra.count") do
      post compras_url, params: { compra: { cantidad: @compra.cantidad, precio_total: @compra.precio_total, producto_id: @compra.producto_id } }
    end
  ...
  test "should update compra" do
    patch compra_url(@compra), params: { compra: { cantidad: @compra.cantidad, precio_total: @compra.precio_total, producto_id: @compra.producto_id } }
